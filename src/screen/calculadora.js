...
function App() {
  ...
  const URLapi = "https://cda9-179-127-67-47.ngrok-free.app/api/estados";
  ...
  const handleEstadoSelecionado = async (itemValue) => {
    ...
    try {
      const response = await axios.get(`https://cda9-179-127-67-47.ngrok-free.app/api/listarPopulacaoEConsumo/${itemValue}`);
